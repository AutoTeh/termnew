...
?>
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="date" name="Date_Sending_Request_TID" value="<?php echo $Date_Sending_Request_TID; ?>" >
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="date" name="Date_Installation_Terminal_TID" value="<?php echo $Date_Installation_Terminal_TID; ?>" >
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="date" name="Date_Dismantling_TID" value="<?php echo $Date_Dismantling_TID; ?>" >
