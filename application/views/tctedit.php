...
<div class="tab-content">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="text" name="Position_Contact_TCT" value="<?php echo $Position_Contact_TCT; ?>" >
  ...
  <div class="control-group">
    ...
    <div class="control-group">
    <div class="controls">
    <label class="checkbox" ><input type="checkbox" name="Repair_TCT" value="1" <?php echo ($Repair_TCT) ? 'checked' : ''; ?> /> ТСТ в ремонте</label>
    </div>
  </div>
  <div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="date" name="Date_Visit_MPR_TCT" value="<?php echo $Date_Visit_MPR_TCT; ?>" >
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="date" name="Date_Implementation_Potok_TCT" value="<?php echo $Date_Implementation_Potok_TCT; ?>" >
