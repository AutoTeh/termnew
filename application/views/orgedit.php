...
<div class="tab-content">
  <div class="tab-pane active" id="org">
    ...
    <div class="controls">
      <input class="span4" type="text" name="Name_Org" value="<?php echo $Name_Org; ?>" >
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="INN_Org">ИНН</label>
    <div class="controls">
      <input class="span4" type="text" name="INN_Org" value="<?php echo $INN_Org; ?>" >
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="FIO_Boss_Org">ФИО руководителя</label>
    <div class="controls">
      <input class="span4" type="text" name="FIO_Boss_Org" value="<?php echo $FIO_Boss_Org; ?>" >
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="E_Mail_Org">E-mail</label>
    <div class="controls">
      <input class="span4" type="text" name="E_Mail_Org" value="<?php echo $E_Mail_Org; ?>" >
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="Phone_Boss_Org">Телефон руководителя</label>
    <div class="controls">
      <input class="span4" type="text" name="Phone_Boss_Org" value="<?php echo $Phone_Boss_Org; ?>" >
    </div>
  </div>
  <div class="control-group">
